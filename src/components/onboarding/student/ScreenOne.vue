      ...
      <form class="input-line">
        ...
        <div v-if="notAllFieldsValid">
          ...
          <div class="form-group required ">
              ...
              <input class="form-control" type="text" placeholder="Headline" v-model="userLocation" v-on:focus="toggleNotValid()">
          </div>
          ...
          <div class="form-group required ">
              ...
              <p v-if="!stanfordEmailIssue" class="text-danger"> Must Provide a Stanford or Alumni Email </p>
...
export default {
  ...
  mounted () {
    ...
    this.userEmail = this.checkForNull(linkedinData.emailAddress)
  ...
  computed: {
    ...
    stanfordEmailIssue () {
      if (/stanford.edu\s*$/.test(this.stanfordEmail) || /stanfordalumni.org\s*$/.test(this.stanfordEmail)) {
        return true
      }
      return false
    }
  ...
  methods: {
    ...
    pushToSecond (url) {
      ...
      userData.stanfordEmail = this.stanfordEmail
      if (!url) {
        userData.profile_img_add = this.userProfileImgSrc
      } else {
        userData.profile_img_add = url
      }
      if (this.valid(userData.first_name, userData.last_name, userData.headline, userData.location, userData.email, userData.stanfordEmail)) {
    ...
    valid (field1, field2, field3, field4, field5, field6) {
      if (field1 && field2 && field3 && field4 && field5 && field6 && this.stanfordEmailIsValid(field6)) return true
