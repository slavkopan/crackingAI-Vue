  ...
  />
    ...
    <div class = "row align-items-center justify-content-center student-profile">
      ...
      <div class= "left-margin student-bio">
        ...
        <div class="" >
          <button type="button" class="btn btn-xl btn-primary" @click="messageStudent()">Message {{student.first_name}}</button>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  mounted () {
    ...
    let self = this
    UserService.getUserIsStudent(studentId).then(function (student) {
